...
def genetic_algorithm(pop_size, num_gens):
    ...
    for gen in range(num_gens):
        ...
        save_to_file("generation" + str(gen + 1) + ".txt", max(evaluated_fitnesses)[1])
    ...
    print(f"Best picobot program with a fitness of {str(top_fitness)}, saved to generation{num_gens}.txt:")
    return best_game[top_fitness]

if __name__ == '__main__':
    genetic_algorithm(200, 15)